...
primg = add_image_to_canvas(canvas, PRvar, x=867, y=164, width=47, height=47)
ovfimg = add_image_to_canvas(canvas, OVFvar, x=864, y=220, width=47, height=47)
...
image = add_image_to_canvas(canvas, image_path, x=865, y=17, width=50, height=20)
